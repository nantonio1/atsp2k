...
*
     ...
     :       (IQMAX,MAX(1))
      ...
      RK = QUADS(i2,i4,1)
      IF(MSOO .EQ. 0) RETURN
      print '(A,5I3,A,I3)', 'In Rk ', i1,i2,i3,i4,k,' MSOO = ', msoo
...
c ! o-o  interaction
      ...
      Print *, 'RK =',rk
      Print '(5I3,A,F15.10)', i1,i2,i3,i4,k, ' ZZ=', ZZ(i1,i2,i3,i4,K)
      Print '(5I3,A,F15.10)', i2,i1,i4,i3,k,' ZZ=',  ZZ(i2,i1,i4,i3,K)
      Print '(5I3,A,F15.10)', i3,i4,i1,i2,K, ' ZZ=', ZZ(i3,i4,i1,i2,K)
      Print '(5I3,A,F15.10)', i4,i3,i2,i1,K, ' ZZ=', ZZ(i4,i3,i2,i1,K)
