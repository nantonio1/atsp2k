...
*        ... since Ssms has not been computed, set to zero
         Ssms(i) = 0.d0
      end do
...
*     print *, 'brci_eig:max', (max_comp(ic1),ic1=1,nume)
