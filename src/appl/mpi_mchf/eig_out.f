...
* make config0 allocatable
*
      double precision wt(*),e(*),isom_shift(MEIG,nblock)
...
*<<< start a loop to find the configurations with max comp of the eigen vector
      ics = 1
      ice = ncfg 
...
*     ... order each configurations to correspond to max comp of the eig vector
     ...
     :        '  NEL = ', nnel, '   NCFG = ',NCFG
      ...
      WRITE (unit_n, '(//A8,I4,2X,A8,I4)' ) '  2*J = ',JJ,'NUMBER =',
     :           neig;
