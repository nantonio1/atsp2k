...
*
     ...
     :       (IQMAX,MAX(1))
      ...
      Print *, 'I1, L(I1), IAZMIN',  I1, L(I1),IAZMIN
      IF (iazmin .EQ. 0) then
         IAZMIN = SUM(MINLOC(AZ(1:NWF)))
         Print *, "The orbital with a minimum AZ is ", IAZMIN
      End IF
*
...
50    RELSH = RELSH  + YK(J-1)
      ...
      IF ( L(I1) .EQ. 0 ) THEN
         II1 = I1
         II2 = I2
         IF (II1 .GT. IAZMIN) II1 = IAZMIN
         IF (II2 .GT. IAZMIN) II2 = IAZMIN
         RELSH = RELSH + Z*AZ(II1)*AZ(II2)
         Print *, ii1, ii1, i1,i2
      END IF
